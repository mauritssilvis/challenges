...
The used configuration extends the [Maven configuration](../basic_maven_project_intellij#12-maven) of [Setting up a basic Maven project using IntelliJ IDEA](../basic_maven_project_intellij).
...
The basic configuration is described in the [IntelliJ IDEA section](../basic_maven_project_intellij#13-intellij-idea) of [Setting up a basic Maven project using IntelliJ IDEA](../basic_maven_project_intellij).
