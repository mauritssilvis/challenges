...
This Java project is managed and built using Maven (see, e.g., the [Maven section](https://github.com/mauritssilvis/challenges/tree/main/java#24-maven) of the [Challenges](https://github.com/mauritssilvis/challenges) > [Java](https://github.com/mauritssilvis/challenges/tree/main/java) project).
