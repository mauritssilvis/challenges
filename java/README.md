...
* [Setting up a Java project using Maven and IntelliJ IDEA](basic-maven-project-intellij)
...
The basic Maven configuration used in the above-mentioned projects is discussed in the [Maven section](basic-maven-project-intellij#13-maven) of [Setting up a Java project using Maven and IntelliJ IDEA](basic-maven-project-intellij).
